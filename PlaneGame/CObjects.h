...
public:
    CObjects();
    ~CObjects();
    void drawAxes(bool sunLight);
    void drawGrid(bool sunLight);
    void drawSun(const double &sunX, const double &sunY, const double &sunZ, bool sunLight);
    void drawEarthPoint(const double &epX, const double &epY, const double &epZ, const double &epDist, bool sunLight);
