...
void CRawFile::loadHeightDataToImageFull(QImage* image, int imageOffsetX, int imageOffsetY, QString name,
...
void CRawFile::loadHeightDataToImagePart(QImage* image, int imageOffsetX, int imageOffsetY, QString name,
    int xToRead, int yToRead, int fileResolution, int skip,
    int filePositionHorizontalOffset, int filePositionVerticalOffset,
    int textureBegginingX, int textureBegginingY)
{
