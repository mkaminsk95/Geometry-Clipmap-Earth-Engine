...
public:
    ...
    quint16& init(int sX, int sY, quint16 *tileHeights);
    void saveFile(QString name);
    static void loadFileBlock(QString name, int x, int y, int fileResolution, int skip);
    static void loadHeightDataToImage(QImage* image, int imageOffsetX, int imageOffsetY, QString name, int verticalPosition, int horizontalPosition, int xToRead, int yToRead, int fileResolution, int skip);
	...
	void getHeightBlockToBuffer(quint16* buffer, int x, int y, int sx, int sy, int skip);
